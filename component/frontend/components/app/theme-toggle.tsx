...
export function ThemeToggle({ className }: ThemeToggleProps) {
  ...
  <div
    className={cn(
      'group relative flex flex-col items-center justify-center gap-2 rounded-full bg-neutral-100 p-2 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800',
      className
    )}
    role="radiogroup"
  ...
  >
    ...
    <p className="text-[10px] text-neutral-500 dark:text-neutral-400">
      Designed by <strong>Mr Om_G</strong>
    </p>
  </div>
);
