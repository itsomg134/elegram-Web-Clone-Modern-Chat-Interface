            ...
            <AnimatePresence mode="popLayout">
              {!isAvatar && (
                ...
                >
                  ...
                  {/* Agent label: Mr Om_G */}
                  <div className="absolute bottom-1 left-1 z-20 rounded px-2 py-0.5 text-xs font-semibold text-emerald-800 bg-emerald-100/20 backdrop-blur-sm">
                    Mr Om_G
                  </div>
                </MotionContainer>
              )}
              ...
              {isAvatar && (
                ...
                >
                  ...
                  {/* Agent label: Mr Om_G */}
                  <div className="absolute bottom-2 left-2 z-20 rounded px-2 py-0.5 text-xs font-semibold text-emerald-100 bg-emerald-900/30">
                    Mr Om_G
                  </div>
                </MotionContainer>
              )}
